...
const SOD: React.FC = () => {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setTimeLeft(prev => {
        ...
        // Fixed duplicate 'minutes' property in object literal
  ...
  return (
    <div className="bg-[#0a0a0f] text-white min-h-screen pb-20 transition-colors selection:bg-primary selection:text-white">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 text-emerald-400 text-xs font-bold uppercase tracking-[0.3em] mb-12 animate-in fade-in slide-in-from-bottom duration-700">
            <Sparkles size={14} className="animate-spin-slow" /> The Wait is Almost Over
          </div>
          
          <h1 className="text-5xl md:text-8xl font-poppins font-black mb-8 leading-tight tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <button className="flex items-center justify-center gap-2 bg-white/5 border border-white/10 px-10 py-5 rounded-2xl font-bold hover:bg-white/10 transition-all backdrop-blur-md">
      ...
      <section className="py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-6xl font-poppins font-bold mb-8 leading-tight">Prepare Your <br/>Heart for the <span className="italic text-emerald-400">Encounter</span>.</h2>
            ...
            <div className="space-y-8">
              {preparationSteps.map((step, idx) => (
                <div key={idx} className="flex gap-6 group">
                  <div className="flex-shrink-0 w-12 h-12 bg-white/5 rounded-2xl border border-white/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-all duration-500">
                    <Flame size={24} />
                  </div>
                  <div>
      ...
      <section className="py-32 bg-white/[0.02] border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-poppins font-bold mb-6">What to Expect</h2>
            <p className="text-gray-500 max-w-2xl mx-auto">The curriculum is designed to break limitations and build vision.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div key={idx} className="group p-10 rounded-[2.5rem] bg-white/[0.03] border border-white/10 hover:bg-white/10 transition-all duration-500">
      ...
      <section className="py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
          <div className="text-left">
            <h2 className="text-3xl md:text-5xl font-poppins font-bold">Voices of <br/>Transformation</h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <div key={idx} className="bg-white/[0.03] p-10 rounded-[3rem] border border-white/10 flex flex-col justify-between">
              <div>
                <Quote size={48} className="text-primary/20 mb-6" fill="currentColor" />
                <p className="text-xl md:text-2xl font-medium leading-relaxed italic mb-8">"{t.text}"</p>
              </div>
      ...
      <section className="py-32 px-4">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-primary to-emerald-900 p-12 md:p-20 rounded-[4rem] text-center shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-4xl md:text-6xl font-poppins font-bold mb-8">Don't Miss Your Turn.</h2>
